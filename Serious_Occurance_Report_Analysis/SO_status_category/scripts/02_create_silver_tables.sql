-- create silver.SO_status

IF OBJECT_ID('silver.SO_status', 'U') IS NOT NULL
	DROP TABLE silver.SO_status;
...
SELECT * FROM silver.SO_status

-- create silver.SO_category
IF OBJECT_ID('silver.SO_category', 'U') IS NOT NULL
	DROP TABLE silver.SO_category;
...
SELECT * FROM silver.SO_category